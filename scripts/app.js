...
const jobsData = [
  {
    ...
    description:
      "Looking for a passionate frontend developer to join our team. Experience with React and TypeScript preferred.",
  ...
  },
  {
    ...
    description:
      "Seeking a full stack developer with experience in Node.js and React. Must have strong problem-solving skills.",
  ...
  },
  {
    ...
    description:
      "Join our design team to create beautiful and intuitive user interfaces. Figma experience required.",
  ...
  },
  {
    ...
    description:
      "Backend developer needed for scalable microservices architecture. Python and Docker experience preferred.",
  ...
  },
  {
    ...
    description:
      "Work with real-world data to build predictive models. Strong Python and statistics background required.",
  ...
  },
  {
    ...
    postedDate: "1 week ago",
    description:
      "Develop cutting-edge mobile applications for iOS and Android. Flutter experience is a plus.",
...
function renderJobs() {
  ...
  jobsData.forEach((job) => {
    ...
    const typeBadgeClass =
      job.type === "Internship" ? "badge-internship" : "badge-fulltime";
